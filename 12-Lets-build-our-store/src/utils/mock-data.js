...
export const restaurants = [
  {
    ...
    cost: 15.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/33101e2fff3a071cbd8b85e73c0d4f45",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
      { name: "Sushi Platter", price: 25.99, rating: 4.0, id: 4 },
      { name: "Taco Plate", price: 12.99, rating: 4.6, id: 5 },
      { name: "Butter Chicken", price: 18.99, rating: 4.2, id: 6 },
      { name: "General Tso's Chicken", price: 14.99, rating: 4.3, id: 7 },
      { name: "Falafel Wrap", price: 17.99, rating: 4.1, id: 8 },
      { name: "BBQ Ribs", price: 20.99, rating: 4.5, id: 9 },
      { name: "Pho Soup", price: 11.99, rating: 4.4, id: 10 },
    ],
  },
  {
    name: "Thai Palace",
    ...
    cost: 12.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/e0vvulfbahjxjz6k4uwi",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 25.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/mpnblqqkh7xpi4h0fnju",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 18.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/dzacemjl8oskvogrxpyw",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 14.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/c7442a4403e49b11621829e1f984e04f",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 17.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/l5sjr78yn3vhopcvqgfb",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 20.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/usvu7jwfx9t47z3y3lkh",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
  ...
  },
  {
    ...
    cost: 16.99,
    image:
      "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/teozu7tcibqgztfsdadi",
    menuOptions: [
      { name: "Chicken Parmesan", price: 12.99, rating: 4.5, id: 1 },
      { name: "Margherita Pizza", price: 15.99, rating: 4.2, id: 2 },
      { name: "Pad Thai", price: 10.99, rating: 4.8, id: 3 },
